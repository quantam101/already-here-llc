...
cover = (
    ...
    "Our base one-time price for the full scope is $15,600 (assuming approximately 700 tagged assets; the site-visit, mobilization, and processing components are fixed, and tags are priced per actual unit). This is an all-in cost of approximately $22.29 per tagged asset at the 700-asset estimate. Pricing is anchored to our published rate card and compared against local small-business IT service rates, not national firms.\n\n"
