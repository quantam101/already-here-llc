...
**RFP:** Arizona Multi-Site Electronics Asset Inventory & 2D QR Tagging  
**Vendor:** Already Here LLC  
**Primary Contact:** Stephen Franklin — dispatch@alreadyherellc.com — (602) 882-2920  
**Date:** August 11, 2026  
...
| Pricing Component | Qty / Basis | Unit Price | Extended / Fixed Price |
|---|---|---|---|
| Project management / kickoff | 1 project | — | $1,500.00 |
| Onsite inventory & tagging | 24 physical site visits | $450.00 per visit | $10,800.00 |
| Asset tags | Per tag / estimated actual | $0.75 per tag | ~$525.00 (estimated 700 tags) |
...
| Travel / mobilization | Arizona project (Phoenix metro) | Included | Included |
...
Rounded proposal total: **$13,600.00**.

**Assumed total asset count:** ~700 tagged assets across 24 physical site visits.  
**Estimated all-in cost per tagged asset:** ~$19.43 at 700 assets; ~$17.00 at 800 assets; ~$22.67 at 600 assets.  
...
**Not-to-exceed:** Base scope not to exceed $14,750 without written change order (excludes P4 option, optional software, and annual re-inventory).

---

## Optional Services

| Optional Service | Pricing | Notes |
|---|---|---|
| Hosted asset-management platform | $1,200/year or $100/month | Web-based register, mobile QR scanning, export to CSV/XLSX, non-proprietary data export guaranteed. |
| Annual physical re-inventory | $7,200/year ($300/site × 24) | Validates asset moves, updates register, replaces missing/damaged tags. |
| PawnCo P4 pre-opening sweep | $500 per visit + $0.75/tag | Performed after equipment is staged/installed; separately scheduled. |
...
- The per-tag rate covers durable 2D QR polyester labels (≈1" × 2") with human-readable asset IDs, suitable for normal indoor commercial use, applied by Already Here field technicians.
