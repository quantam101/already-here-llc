        ...
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-500">
              This page stays available with or without external APIs, cloud access, or quota availability. Use the command prompt below to test the local and server-backed response paths.
            </p>
          </div>
