...
// v5 backend — FastAPI on the Render runtime.
// Override with PROFITENGINE_ORACLE_BASE_URL env var if needed.
const runtimeBaseUrl = (
  process.env.PROFITENGINE_ORACLE_BASE_URL || 'https://profitengine-runtime.onrender.com'
).replace(/\/$/, '');
  ...
  const summary =
    onlineCount === endpoints.length
      ...
      : onlineCount > 0
        ...
        : 'ProfitEngine v5 runtime is not reachable from the Vercel status surface. Check PROFITENGINE_ORACLE_BASE_URL and the Render runtime.';
