...
const faqs = [
  ...
  {
    q: 'Are you registered for procurement work?',
    a: 'Already Here LLC is SAM.gov registered and keeps certification claims separate from public marketing copy until they are verified.'
  },
  {
