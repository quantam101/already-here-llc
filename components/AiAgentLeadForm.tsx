  ...
  return (
    <form id="ai-agent-free-trial" className="card p-6 sm:p-8" onSubmit={handleSubmit} noValidate>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <label className="grid gap-2 text-sm font-medium text-navy">Website or domain<input name="website" type="url" maxLength={240} className="link-ring rounded-2xl border border-borderBrand px-4 py-3 text-sm text-ink placeholder:text-slate-400" placeholder="https://www.your-domain.com" /></label>
