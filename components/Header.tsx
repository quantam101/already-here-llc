        ...
        <div id="mobile-nav" className="border-t border-white/10 bg-[#071B34] xl:hidden">
          <div className="container-shell flex flex-col gap-3 py-4">
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              ...
              <Link href="/emergency-dispatch" className="link-ring rounded-2xl border border-[#1B66FF] bg-[#1B66FF] px-4 py-3 text-center text-sm font-semibold text-white" onClick={() => setOpen(false)}>
                Same-Day Dispatch
              </Link>
            </div>
          </div>
